...
import { Calendar, Users, CheckCircle, XCircle, LogOut, Filter, X as XIcon } from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  // Get unique dates from bookings for quick date selection
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#140f2d] to-black flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#140f2d] to-black p-8">
